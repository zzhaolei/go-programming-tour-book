...
import (
	...
	"github.com/zzhaolei/go-programming-tour-book/tour/internal/sql2struct"
)
...
var sql2structCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err := dbModel.Connect()
		if err != nil {
			log.Fatalf("dbModle.Connect err: %v", err)
		}
...
func init() {
	...
	sql2structCmd.Flags().StringVarP(&charset, "charset", "", "utf8mb4", "请输入数据库的字符集")
